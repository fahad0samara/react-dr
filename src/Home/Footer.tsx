...
<div className="2xl:mx-auto 2xl:container mx-4 py-16 text-white">
            <div className=" w-full  relative flex items-center justify-center">
                <img src={img} alt="dining" className="w-full h-full absolute z-0 " />
                ...
                <div className="bg-gray-800 bg-opacity-80 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
                    ...
                    <p
                    data-aos="fade-down"
                    className="text-base leading-normal text-center mt-6">
                    ...
                    <div className="sm:border border-white flex-col sm:flex-row  flex items-center lg:w-5/12 w-full mt-12 space-y-4 sm:space-y-0">
                        ...
                        <button className="focus:outline-none focus:ring-offset-2 focus:ring border border-white sm:border-transparent w-full sm:w-auto bg-yellow-200 text-black py-4 px-6 hover:bg-opacity-75">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            <div className="md:max-w-md lg:col-span-2">
              ...
              className="mt-4 lg:max-w-sm">
                ...
                hospital or clinic. They coordinate and direct medical and health services for an entire facility or a medical department within a 
                </p>
              </div>
            </div>
            <div
