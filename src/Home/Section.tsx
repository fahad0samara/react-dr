...
export const Section = () => {
    return (
        <div>
            ...
            <div className="py-20  text-black  mt-10  ml-20 md:py-28">
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-auto py-1 md:py-0 md:mr-4"><a className="inline-block py-5 px-7 w-full text-base md:text-lg leading-4 rounded-xl drop-shadow-2xl  font-medium text-center bg-[#cce5f8] hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border  rounded-md shadow-sm" href="#">Schedule Appointment</a></div>
