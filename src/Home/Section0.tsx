...
const Section0 = () => {
  return (
   ...
   <img 
   data-aos="fade-left"
   className='hidden md:block w-1/2 ml-5' src={img} alt=""  />
    <div className='mt-10 space-y-4 col-span-3 '>
<h1
data-aos="zoom-in-right"
className=' font-black text-2xl text-center text-[#9dccf1] '>Our Stats show that we've
Happy Potients

</h1>
<h3
data-aos="zoom-out-up"
className='text-center text-xl  font-semibold m-4 md:m-0  md:text-2xl'>And excellence partiality estimating terminated day everything</h3>
        </div>
    <img
    data-aos="fade-right"
    className=' hidden md:block w-1/2 ml-20' src={img0} alt=""  />
